    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="<?php echo e(route('admin.settings')); ?>" class="menu-item active">
    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="info-grid">
                ...
                <div class="info-value"><?php echo e(config('app.env')); ?></div>

                <div class="info-label">Database:</div>
                <div class="info-value"><?php echo e(config('database.default')); ?></div>

                <div class="info-label">Timezone:</div>
                <div class="info-value"><?php echo e(config('app.timezone')); ?></div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <a href="<?php echo e(route('admin.users.index')); ?>" style="color: #1e40af; text-decoration: none;">
                    <i class="bi bi-people"></i> Manage Users
                </a>
                <a href="<?php echo e(route('dashboard')); ?>" style="color: #1e40af; text-decoration: none;">
...
<?php /**PATH C:\Users\keeia\OneDrive\Documents\Capstone1-web-mayerror\capstone\resources\views/admin/settings.blade.php ENDPATH**/ ?>