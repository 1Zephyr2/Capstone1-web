...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-center">
                <a href="<?php echo e(route('customer.dashboard')); ?>" class="nav-item active">
                    ...
                    <div class="notification-dropdown" id="notificationDropdown">
                        ...
                        <?php if($notifications->count() > 0): ?>
                            <div class="notification-footer">
                                <a href="<?php echo e(route('customer.notifications')); ?>">View All Notifications →</a>
                            </div>
                        <?php endif; ?>
                    </div>
                    <script>
                        ...
                        function markAllAsRead() {
                            fetch('<?php echo e(route("customer.notifications.mark-all-read")); ?>', {
                                method: 'POST',
                                headers: {
                        ...
                        function notificationClick(id) {
                            fetch(`<?php echo e(url('customer/notifications')); ?>/${id}/read`, {
                                method: 'POST',
                                headers: {
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                                }
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <p class="page-subtitle"><?php echo e(auth()->user()->email); ?></p>
        </div>
        ...
        <div class="cards-container">
            <div class="card">
                ...
                <div class="stat-number"><?php echo e($pets->count()); ?></div>
                <div class="card-content">
                    You have <?php echo e($pets->count()); ?> pet<?php echo e($pets->count() != 1 ? 's' : ''); ?> registered.
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="stat-number"><?php echo e($appointments->count()); ?></div>
                <div class="card-content">
                    <?php echo e($appointments->count()); ?> appointment<?php echo e($appointments->count() != 1 ? 's' : ''); ?> scheduled.
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; gap: 12px; margin-bottom: 32px; flex-wrap: wrap;">
            <a href="<?php echo e(route('appointment-requests.create')); ?>" style="padding: 14px 24px; background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); color: white; border: none; border-radius: 8px; cursor: pointer; font-size: 14px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 4px 12px rgba(20, 184, 166, 0.3); transition: all 0.3s; text-decoration: none;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 16px rgba(20, 184, 166, 0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 12px rgba(20, 184, 166, 0.3)'">
                <i class="bi bi-calendar-plus"></i>
                Request an Appointment
            </a>
            <a href="<?php echo e(route('customer.pets.index')); ?>" style="padding: 14px 24px; background: white; color: #14b8a6; border: 2px solid #14b8a6; border-radius: 8px; font-size: 14px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; transition: all 0.3s;" onmouseover="this.style.background='#f0fdf4'" onmouseout="this.style.background='white'">
                <i class="bi bi-paw-fill"></i>
                View All Pets
            </a>
            <a href="<?php echo e(route('customer.appointments.index')); ?>" style="padding: 14px 24px; background: white; color: #06b6d4; border: 2px solid #06b6d4; border-radius: 8px; font-size: 14px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; transition: all 0.3s;" onmouseover="this.style.background='#ecf9ff'" onmouseout="this.style.background='white'">
                ...
                <div class="pets-list">
                    <?php $__currentLoopData = $pets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pet-item">
                            ...
                            <a href="<?php echo e(route('customer.pets.show', $pet)); ?>" class="pet-link">
                ...
                <?php $__currentLoopData = $appointments->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="appointment-item">
                        <div class="appointment-info">
                            <h4><?php echo e($appointment->patient->pet_name ?? 'Unknown Pet'); ?> - <?php echo e($appointment->service_type ?? 'Appointment'); ?></h4>
                            <p>
                        ...
                        <a href="<?php echo e(route('customer.appointments.show', $appointment)); ?>" class="pet-link">
                            <i class="bi bi-arrow-right"></i>
                            View
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if($appointments->count() > 5): ?>
                    <div style="text-align: center; margin-top: 16px;">
                        <a href="<?php echo e(route('customer.appointments.index')); ?>" class="pet-link">View All Appointments</a>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
...
<?php /**PATH C:\Users\keeia\OneDrive\Documents\Capstone1-web-mayerror\capstone\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>