...
<body>
        ...
        <div class="navbar-container">
            ...
            <div class="navbar-end">
                ...
                <div class="user-avatar">
                    <a href="<?php echo e(route('profile.show')); ?>" style="text-decoration: none; color: white;" title="View Profile">
    ...
    <div class="main-content">
        <div class="container">
            ...
            <form action="<?php echo e(route('customer.pets.store')); ?>" method="POST" enctype="multipart/form-data" id="petForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-card">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="pet_name" class="form-control" required value="<?php echo e(old('pet_name')); ?>" placeholder="e.g., Buddy, Whiskers">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="species_id" id="species_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $species; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>" <?php echo e(old('species_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="breed" class="form-control" required value="<?php echo e(old('breed')); ?>" placeholder="e.g., Golden Retriever, Persian">
                        </div>

                        <div class="form-group">
                            <label>Color</label>
                            <input type="text" name="color" class="form-control" value="<?php echo e(old('color')); ?>" placeholder="e.g., Brown, White">
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="date" name="birthdate" class="form-control" required value="<?php echo e(old('birthdate')); ?>" max="<?php echo e(date('Y-m-d')); ?>">
                    ...
                    <div class="optional-section">
                        <div class="form-group full-width" style="margin-bottom: 20px;">
                            <label class="checkbox-label">
                                <input type="checkbox" name="has_special_needs" value="1" <?php echo e(old('has_special_needs') ? 'checked' : ''); ?>>
                                <div>
...
<?php /**PATH C:\Users\keeia\OneDrive\Documents\Capstone1-web-mayerror\capstone\resources\views/customer/pets/create.blade.php ENDPATH**/ ?>