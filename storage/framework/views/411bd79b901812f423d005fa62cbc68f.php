    ...
    <nav>
        <div class="nav-container">
            ...
            <div class="nav-cta">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login', ['role' => 'staff'])); ?>" class="btn-login">Staff</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
        ...
        <div class="hero-card">
            ...
            <div class="hero-left">
                ...
                <div class="login-options">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('customer.login')); ?>" class="login-btn pet-owner">
                            <i class="bi bi-person"></i>
                            Login as Pet Owner
                        </a>
                        <div class="signup-link">
                            Don't have an account? <a href="<?php echo e(route('customer.register.show')); ?>">Sign up here</a>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php /**PATH C:\Users\keeia\OneDrive\Documents\Capstone1-web-mayerror\capstone\resources\views/welcome.blade.php ENDPATH**/ ?>