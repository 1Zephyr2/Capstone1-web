...
<head>
    ...
    <title>Edit Pet – <?php echo e($patient->pet_name); ?></title>
...
<div class="container">
    ...
    <div class="page-header">
        <a href="<?php echo e(route('pets.show', $patient)); ?>" class="btn-back">
            <i class="bi bi-arrow-left"></i> Back
        </a>
        <div class="page-title">Edit Pet Profile</div>
        <div class="page-sub">Last updated <?php echo e($patient->updated_at->format('M d, Y')); ?></div>
    </div>
    ...
    <form action="<?php echo e(route('pets.update', $patient)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="photo-section">
                <div class="photo-preview" id="photoPreviewBox">
                    <?php if($patient->pet_photo_path): ?>
                        <img id="photoPreviewImg" src="<?php echo e(asset('storage/' . $patient->pet_photo_path)); ?>" alt="Pet photo">
                    <?php else: ?>
                ...
                <div class="photo-upload-info">
                    <h3>Upload a photo of <?php echo e($patient->pet_name); ?></h3>
                    <p>JPG, PNG or GIF &middot; Max 4 MB</p>
                    <label for="pet_photo" class="btn-upload-photo">
                        <i class="bi bi-upload"></i>
                        <?php echo e($patient->pet_photo_path ? 'Change Photo' : 'Upload Photo'); ?>
            ...
            <div class="card-body">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="pet_name" value="<?php echo e(old('pet_name', $patient->pet_name)); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="species_id" id="speciesSelect" required onchange="loadSpeciesCharacteristics()">
                            ...
                            <?php $__currentLoopData = $species; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sp->id); ?>" <?php echo e(old('species_id', $patient->species_id) == $sp->id ? 'selected' : ''); ?>><?php echo e($sp->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label>Breed</label>
                        <input type="text" name="breed" value="<?php echo e(old('breed', $patient->breed)); ?>" placeholder="e.g. Labrador Retriever">
                    </div>
                    <div class="form-group">
                        <label>Color / Markings</label>
                        <input type="text" name="color" value="<?php echo e(old('color', $patient->color)); ?>" placeholder="e.g. Golden, white paws">
                    </div>
                    <div class="form-group">
                        <label>Date of Birth <span class="req">*</span></label>
                        <input type="date" name="birthdate" value="<?php echo e(old('birthdate', $patient->birthdate?->format('Y-m-d'))); ?>" max="<?php echo e(date('Y-m-d')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="sex" required>
                            <?php $__currentLoopData = ['Male','Female','Neutered Male','Spayed Female']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s); ?>" <?php echo e(old('sex', $patient->sex) === $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['sex'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
            ...
            <div class="card-body">
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="owner_name" value="<?php echo e(old('owner_name', $patient->owner_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="owner_contact" value="<?php echo e(old('owner_contact', $patient->owner_contact)); ?>" placeholder="e.g. 09171234567">
                    </div>
                    <div class="form-group form-grid full">
                        <label>Address <span class="req">*</span></label>
                        <input type="text" name="address" value="<?php echo e(old('address', $patient->address)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-grid">
                    <div class="form-group" style="align-items: flex-start;">
                        <label style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px; margin-top: 4px;">
                            <input type="checkbox" name="is_required" value="1" <?php echo e(old('is_required', $patient->is_required) ? 'checked' : ''); ?> style="width: auto; cursor: pointer;">
                    ...
                    <div class="form-group" style="align-items: flex-start;">
                        <label style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px; margin-top: 4px;">
                            <input type="checkbox" name="privacy_consent" value="1" <?php echo e(old('privacy_consent', $patient->privacy_consent) ? 'checked' : ''); ?> style="width: auto; cursor: pointer;">
        ...
        <div class="card">
            <div class="form-footer">
                <a href="<?php echo e(route('pets.show', $patient)); ?>" class="btn-cancel">Cancel</a>
...
<?php /**PATH C:\Users\Lei\Capstone1-web\resources\views/pets/edit.blade.php ENDPATH**/ ?>