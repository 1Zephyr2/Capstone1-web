...
<body>
<div class="container">
    <a href="<?php echo e(route('appointments.index')); ?>" class="back-button">
    ...
    <div class="content-grid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="info-row">
                    <label>Date:</label>
                    <span><?php echo e($appointment->appointment_date->format('F d, Y')); ?></span>
                </div>
                <div class="info-row">
                    <label>Time:</label>
                    <span><?php echo e(\Carbon\Carbon::parse($appointment->appointment_time)->format('h:i A')); ?></span>
                </div>
                <div class="info-row">
                    <label>Service Type:</label>
                    <span class="badge badge-info"><?php echo e($appointment->service_type); ?></span>
                </div>
                <div class="info-row">
                    <label>Status:</label>
                ...
                <div class="info-row">
                    ...
                    <span><?php echo e($appointment->health_worker ?? 'Not assigned'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="info-row">
                    <label>Pet ID:</label>
                    <span><?php echo e($appointment->patient->patient_id); ?></span>
                </div>
                <div class="info-row">
                    <label>Name:</label>
                    <span>
                        <a href="<?php echo e(route('pets.show', $appointment->patient)); ?>" class="link">
                ...
                <div class="info-row">
                    <label>Age:</label>
                    <span><?php echo e($appointment->patient->age); ?> years old</span>
                </div>
                <div class="info-row">
                    <label>Sex:</label>
                    <span><?php echo e($appointment->patient->sex); ?></span>
                </div>
                <div class="info-row">
                    <label>Owner Contact:</label>
                    <span><?php echo e($appointment->patient->owner_contact ?? 'N/A'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="card full-width">
            ...
            <div class="card-body">
                <div class="info-row">
                    ...
                    <span><?php echo e($appointment->chief_complaint ?? 'Not specified'); ?></span>
                </div>
...
<?php /**PATH C:\Users\Lei\Capstone1-web\resources\views/appointments/show.blade.php ENDPATH**/ ?>