    ...
    <style>
        * {
        ...
        .appointment-item:hover {
            background: linear-gradient(135deg, #e0fdf8 0%, #f9fafb 100%);
...
<body>
    ...
    <div id="bookAppointmentModal" class="ai-modal" onclick="closeModalOnBackdrop(event, 'bookAppointment')">
        <div class="ai-modal-content" style="max-width: 650px;">
            <div class="ai-modal-header" style="background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); padding: 24px 32px;">
            ...
            <div class="ai-modal-body" style="padding: 28px; max-height: calc(85vh - 80px);">
                <form id="appointmentForm" action="<?php echo e(route('appointments.store')); ?>" method="POST" style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 8px; padding-top: 20px; border-top: 2px solid #f3f4f6;">
                        ...
                        <button type="submit" style="padding: 12px 28px; border: none; background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); color: white; border-radius: 10px; font-weight: 600; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 12px rgba(20, 184, 166, 0.3); font-size: 14px;">
            ...
            <div class="ai-modal-body" style="padding: 20px;">
                <div style="text-align: center; margin-bottom: 20px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        <button onclick="scheduleChangeMonth(-1)" style="padding: 8px 16px; background: #14b8a6; color: white; border: none; border-radius: 6px; cursor: pointer;">← Previous</button>
                        <h3 id="scheduleCurrentMonth" style="margin: 0;">February 2026</h3>
                        <button onclick="scheduleChangeMonth(1)" style="padding: 8px 16px; background: #14b8a6; color: white; border: none; border-radius: 6px; cursor: pointer;">Next →</button>
                    </div>
    ...
    <script>
                ...
                modalAppointmentList.innerHTML = appointments.map(apt => `
                    <div class="calendar-date-appointment-item">
                        ...
                        <div style="display: flex; gap: 8px; margin-top: 12px;">
                            <button onclick="markAttendance(event, ${apt.id}, 'attended'); closeCalendarModal();" style="flex: 1; background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); color: white; border: none; padding: 8px; border-radius: 8px; font-size: 12px; font-weight: 600; cursor: pointer; transition: all 0.2s;" 
        ...
        function displayAppointments(dateStr) {
            ...
            appointmentList.innerHTML = `
                <div style="padding: 16px; background: linear-gradient(135deg, #14b8a6 0%, #0d9488 100%); color: white; border-radius: 8px; margin-bottom: 16px;">
...
<?php /**PATH C:\Users\keeia\OneDrive\Documents\Capstone1-web-mayerror\capstone\resources\views/dashboard.blade.php ENDPATH**/ ?>