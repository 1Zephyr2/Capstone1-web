...
<body>
    <div class="container">
        <a href="<?php echo e(route('appointments.index')); ?>" class="back-btn">← Back to Appointments</a>
        <div class="header">
        ...
        <form action="<?php echo e(route('appointments.store')); ?>" method="POST" id="appointmentForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <select name="patient_id" id="patient_id" required style="display:none;">
                            ...
                            <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patientItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($patientItem->id); ?>"
                                    data-patient-id="<?php echo e($patientItem->patient_id); ?>"
                                    data-contact="<?php echo e($patientItem->owner_contact ?? ''); ?>"
                                    data-age="<?php echo e($patientItem->age); ?>"
                                    data-sex="<?php echo e($patientItem->sex); ?>"
                                    data-pet-name="<?php echo e($patientItem->pet_name); ?>"
                                    data-species="<?php echo e($patientItem->species); ?>"
                                    data-breed="<?php echo e($patientItem->breed ?? ''); ?>"
                                    data-owner-name="<?php echo e($patientItem->owner_name ?? ''); ?>"
                                    <?php echo e((old('patient_id') ?? optional($patient)->id) == $patientItem->id ? 'selected' : ''); ?>>
                                    <?php echo e($patientItem->full_name); ?> (<?php echo e($patientItem->patient_id); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="date" name="appointment_date" id="appointment_date" class="form-control"
                               value="<?php echo e(old('appointment_date', now()->format('Y-m-d'))); ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            ...
                            <option value="no-show" <?php echo e(old('status') == 'no-show' ? 'selected' : ''); ?>>No-Show</option>
                        </select>
                    </div>
                    <div class="form-group full-width">
                        <label for="chief_complaint">Chief Complaint</label>
                        <textarea name="chief_complaint" id="chief_complaint" class="form-control" rows="3"><?php echo e(old('chief_complaint')); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="health_worker">Veterinary Staff</label>
                        <input type="text" name="health_worker" id="health_worker" class="form-control"
                               value="<?php echo e(old('health_worker', auth()->user()->name ?? '')); ?>">
                    </div>
                    <div class="form-group full-width">
    ...
    <script>
        ...
        const checkConflicts = async () => {
            ...
            try {
                const response = await fetch(`<?php echo e(route('appointments.conflicts')); ?>?patient_id=${patientId}&date=${dateValue}`, {
                    headers: {
...
<?php /**PATH C:\Users\Lei\Capstone1-web\resources\views/appointments/book.blade.php ENDPATH**/ ?>