...
<head>
    ...
    <title>Admin Dashboard - PAWser</title>
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo-container">
                <div class="logo-icon">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="<?php echo e(route('admin.settings')); ?>" class="menu-item">
        ...
        <div class="user-section">
            <div class="user-info-sidebar">
                ...
                <div class="user-details-sidebar">
                    <div class="user-name-sidebar"><?php echo e(Auth::user()->name); ?></div>
                    <div class="user-role-sidebar">Administrator</div>
                </div>
            </div>
            <a href="<?php echo e(route('profile.show')); ?>" class="logout-btn-sidebar" style="text-decoration: none; margin-bottom: 8px;">
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e(number_format($stats['total_visits_this_month'])); ?></div>
                <div class="stat-change"><?php echo e(now()->format('F Y')); ?></div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e(number_format($stats['total_appointments_today'])); ?></div>
                <div class="stat-change"><?php echo e(now()->format('F j, Y')); ?></div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-change"><?php echo e($stats['admin_count']); ?> Admins, <?php echo e($stats['staff_count']); ?> Staff</div>
            </div>
        </div>
                        ...
                        <?php $__currentLoopData = $recentVisits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="activity-item">
                                <div class="activity-date">
                                    <?php echo e(\Carbon\Carbon::parse($visit->date)->format('M j')); ?>

                                </div>
                                <div class="activity-content">
                                    <div class="activity-title">Pet Visits</div>
                                    <div class="activity-count"><?php echo e($visit->count); ?></div>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\keeia\OneDrive\Documents\Capstone1-web-mayerror\capstone\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>