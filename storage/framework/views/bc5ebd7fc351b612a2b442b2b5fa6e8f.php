        ...
        <div class="login-left">
            <div class="login-container">
                <div class="login-header">
                    <div class="logo"><img src="<?php echo e(asset('newlogo.png')); ?>" alt="PAWSER Logo"></div>
                    <h1>PAWSER</h1>
                ...
                <div class="footer-text">
                    &copy; <?php echo e(date('Y')); ?> PAWSER. Designed for Pet Grooming Clinic Staff.
                </div>

                <div class="register-text">
                    Are you a pet owner? <a href="<?php echo e(route('customer.register.show')); ?>">Create an account here</a>
                </div>
            </div>
        </div>
