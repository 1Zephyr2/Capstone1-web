    ...
    <div class="main-content">
        ...
        <div class="pet-header">
            <div class="pet-header-info">
                <?php if($pet->pet_photo_path): ?>
                    <img src="<?php echo e(asset('storage/' . $pet->pet_photo_path)); ?>" alt="<?php echo e($pet->pet_name); ?>" class="pet-photo">
                <?php else: ?>
                ...
                <div class="records-list">
                    <?php $__currentLoopData = $pet->visits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="record-item">
                            <div class="record-title"><?php echo e($visit->service_type ?? 'Visit'); ?></div>
            ...
            <?php else: ?>
                <div class="records-list">
                    <?php $__currentLoopData = $pet->appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="record-item">
                            <div class="record-title"><?php echo e($appointment->service_type ?? 'Appointment'); ?></div>
                            <div class="record-info">
                                <i class="bi bi-calendar-event"></i>
...
<?php /**PATH C:\Users\Lei\Capstone1-web\resources\views/customer/pets/show.blade.php ENDPATH**/ ?>