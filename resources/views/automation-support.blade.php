        ...
        <div class="alerts-grid">
            ...
            <div class="alert-card">
                ...
                @forelse($incompleteRecords as $patient)
                    <a href="{{ route('patients.show', $patient->id) }}" class="alert-item">
            ...
            <div class="alert-card">
                ...
                @forelse($overdueImmunizations as $immunization)
                    <a href="{{ route('immunizations.index') }}?patient={{ $immunization->patient->id }}" class="alert-item danger">
            ...
            <div class="alert-card">
                ...
                @forelse($highRiskPrenatal as $record)
                    <a href="{{ route('prenatal.care') }}?patient={{ $record->patient->id }}" class="alert-item danger">
            ...
            <div class="alert-card">
                ...
                @forelse($recentVisits as $visit)
                    <a href="{{ route('patients.show', $visit->patient->id) }}" class="alert-item success">
