...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Create a new pet profile with your pet's information</p>
        </div>
        ...
        <div class="card">
            ...
            <form action="{{ route('customer.pets.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pet_name" required value="{{ old('pet_name') }}" placeholder="e.g., Buddy, Whiskers">
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Color</label>
                        <input type="text" name="color" value="{{ old('color') }}" placeholder="e.g., Brown, Black & White">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="sex" required>
                            ...
                            <option value="Neutered Male" {{ old('sex') == 'Neutered Male' ? 'selected' : '' }}>Neutered Male</option>
                            <option value="Spayed Female" {{ old('sex') == 'Spayed Female' ? 'selected' : '' }}>Spayed Female</option>
                        </select>
                    </div>
                </div>
