...
<head>
    ...
    <title>Register New Pet - FURCARE</title>
            ...
            <div class="form-card">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="breed" value="{{ old('breed') }}" class="form-control" required placeholder="e.g., Golden Retriever, Persian">
                    </div>
                    <div class="form-group">
                        <label>Color</label>
                        <input type="text" name="color" value="{{ old('color') }}" class="form-control" placeholder="e.g., Brown, White">
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="date" id="birthdate" name="birthdate" value="{{ old('birthdate') }}" class="form-control" required max="{{ date('Y-m-d') }}">
            ...
            <div class="form-card">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="owner_contact" value="{{ old('owner_contact') }}" class="form-control" required placeholder="09XX-XXX-XXXX">
                    </div>
                </div>
