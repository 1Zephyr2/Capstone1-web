...
<head>
    ...
    <title>Request Appointment - FURCARE</title>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('appointment-requests.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="patient_id" required>
                            ...
                            @foreach ($pets as $pet)
                                <option value="{{ $pet->id }}" {{ old('patient_id') == $pet->id ? 'selected' : '' }}>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="requested_date" required min="{{ date('Y-m-d') }}" value="{{ old('requested_date', date('Y-m-d')) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="preferred_notes" placeholder="Please tell us any additional details about your appointment request...">{{ old('preferred_notes') }}</textarea>
                    </div>
