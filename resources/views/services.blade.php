    ...
    <div class="container">
        ...
        <section class="pricing-section">
            ...
            <div style="text-align: center; margin-top: 50px;">
                <a href="{{ route('login') }}" class="btn-white" style="padding: 12px 32px; background: linear-gradient(135deg, #0d9488 0%, #06b6d4 100%); color: white; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px; display: inline-block; transition: all 0.3s ease; border: none;">Login to Access</a>
            </div>
        </section>
